  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
      <motion.div 
        ...
        className="bg-black/20 p-6 rounded-xl border border-white/10 backdrop-blur-sm"
      >
        <div className="flex items-center justify-between">
          <div>
            <p className="text-white/60 text-sm">Credits Available</p>
            <h3 className="text-3xl font-bold text-white mt-1">{loading ? '-' : credits}</h3>
          </div>
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            ...
            <h3 className="text-3xl font-bold text-white mt-1">{loading ? '-' : imageCount}</h3>
          </div>
